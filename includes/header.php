...
<body>
  <header class="py-1 mb-0 border-bottom bg-primary">
    <a href="../index.php"><span style="font-size:2em; font-weight:bold; color:white;" class="px-4">KinBech
        Store</span></a>
    ...
    <div class="container-fluid d-grid align-items-center" style="grid-template-columns: 1fr 20fr 1fr;">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu shadow border bg-success dorops" aria-labelledby="dropdownNavLink">
          <?php
      ...
      <div class="d-flex align-items-center search">
        ...
        <button style="position:relative; border-radius:50px; margin-left:-1%;" class="btn btn-warning " type="submit"><i class="fas fa-search"></i></button>
