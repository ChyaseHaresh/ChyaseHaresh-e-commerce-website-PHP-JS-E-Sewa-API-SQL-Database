    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link bg-primary text-light" href="orders.php">
          ...
          <?php
            ...
            <tbody>
              <tr>
                ...
                <td><?php echo $resData['customerId'] ?></td>
                <td><?php echo $resData['fname']." ".$resData['lname'] ?></td>
                <td><?php echo $resData['address'] ?></td>
                <td><?php echo $resData['contact'] ?></td>
                <td><?php echo $resData['date'] ?></td>
                <td><a class="btn btn-success" href="order_detail.php?opid=<?php echo $resData['customerId'] ?>">See Order Details</a></td>
              </tr>
              <?php } ?>
            </tbody>
        </table>
