    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link bg-primary text-light" href="products.php">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group me-2">
            <a href="add_product.php" class="btn btn-sm btn-outline-secondary">Add More</a>
        ...
        <table class="table table-striped table-sm">
          ...
          <?php
              foreach ($result as $key => $resData) {
                $_SESSION['id']=$resData['fp_id'];
              ?>    
                    <tr id="row">
                    <td><?php echo $key + 1 ?></td>
                    <td><a href="edit.php?id=<?php echo $resData['fp_id'] ?>">
                    
                    <?php echo $resData['fp_name'] ?></a></td>
                    <td><?php echo $resData['brand'] ?></td>
                    <td><?php echo $resData['fp_category'] ?></td>
                    <td><?php echo $resData['fp_amount'] ?></td>
                    <td><?php echo $resData['price'] ?></td>
                    <td><?php echo $resData['discount'] ?></td>
                    <td><?php echo $resData['featured'] ?></td>
                    <td><?php echo $resData['delivery'] ?></td>
                  </tr>
              <?php } ?>
          </tbody>
        </table>
